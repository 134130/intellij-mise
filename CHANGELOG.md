...
- Refactor WSL path resolving logic for multi-WSL distributions
- Add cache for Mise CLI executions with watching file system changes
- Added an option to control plugin injection functionality
...
- pycharm: support mise env vars in Python Console by @tomasd

### Fixes

- Fix Jackson deserialization failure for MiseDevTool with missing optional fields by @Copilot
- Use shimsVersion for SDK integration by @134130
...
- PyCharm does not support test configuration envs
...
[Unreleased]: https://github.com/134130/intellij-mise/compare/v5.18.1...HEAD
